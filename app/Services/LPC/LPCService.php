            ...
            while ($index < sizeof($groups)) {
                ...
                if (sizeof($groupsExploded) === 1) {
                    ...
                    */
                    ...
                    if (
                        ConsonantsAndVowels::getKey($groupsExploded[0]) === 'consonant' &&
                        ConsonantsAndVowels::getKey($groupsExploded[1]) === 'vowel')
                    {
                        $key = KeyAndPosition::getKeyName($groupsExploded[0]);
                        $position = KeyAndPosition::getPositionName($groupsExploded[1]);
                    } else if (
                        ConsonantsAndVowels::getKey($groupsExploded[0]) === 'vowel' &&
                        ConsonantsAndVowels::getKey($groupsExploded[1]) === 'consonant')
                    {
