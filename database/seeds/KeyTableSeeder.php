...
class KeyTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        Key::create([
            'key'        => 'fantome',
            'position'   => 'bain_bleu',
            'image'      => '/storage/fantome_bain_bleu_default@2x.png',
            'library_id' => 1,
        ]);
        Key::create([
            'key'        => 'fantome',
        ...
        Key::create([
            'key'        => 'beni',
            'position'   => 'bain_bleu',
            'image'      => '/storage/beni_bain_bleu_default@2x.png',
            'library_id' => 1,
        ]);
        Key::create([
            'key'        => 'beni',
            'position'   => 'pigeon_blanc',
            'image'      => '/storage/beni_pigeon_blanc_default@2x.png',
            'library_id' => 1,
        ]);
        Key::create([
            'key'        => 'beni',
        ...
        Key::create([
            'key'        => 'gare',
            'position'   => 'bain_bleu',
            'image'      => '/storage/gare_bain_bleu_default@2x.png',
            'library_id' => 1,
        ]);
        Key::create([
            'key'        => 'gare',
        ...
        Key::create([
            ...
            'image'      => '/storage/gare_ou_est_paul_default@2x.png',
            'library_id' => 1,
        ]);
        Key::create([
            'key'        => 'gare',
            'position'   => 'un_zebu',
            'image'      => '/storage/gare_un_zebu_default@2x.png',
            'library_id' => 1,
        ]);
        Key::create([
            'key'        => 'vos_cases',
        ...
        Key::create([
            'key'        => 'vos_cases',
            'position'   => 'bain_bleu',
            'image'      => '/storage/vos_cases_bain_bleu_default@2x.png',
            'library_id' => 1,
        ]);
        Key::create([
            'key'        => 'vos_cases',
        ...
        Key::create([
            'key'        => 'vos_cases',
            'position'   => 'un_zebu',
            'image'      => '/storage/vos_cases_un_zebu_default@2x.png',
            'library_id' => 1,
        ]);
        Key::create([
            'key'        => 'rance',
        ...
        Key::create([
            'key'        => 'champignon',
            'position'   => 'ou_est_paul',
            'image'      => '/storage/champignon_ou_est_paul_default@2x.png',
            'library_id' => 1,
        ]);
        Key::create([
            'key'        => 'champignon',
        ...
        Key::create([
            'key'        => 'fille',
            'position'   => 'oh_le_lac',
            'image'      => '/storage/fille_oh_le_lac_default@2x.png',
            'library_id' => 1,
        ]);
        Key::create([
            'key'        => 'fille',
            'position'   => 'bain_bleu',
            'image'      => '/storage/fille_bain_bleu_default@2x.png',
            'library_id' => 1,
        ]);
        Key::create([
            'key'        => 'fille',
        ...
        Key::create([
            'key'        => 'fille',
            'position'   => 'ou_est_paul',
            'image'      => '/storage/fille_ou_est_paul_default@2x.png',
            'library_id' => 1,
        ]);
        Key::create([
            'key'        => 'fille',
        ...
        Key::create([
            'key'        => 'des_jupes',
            'position'   => 'bain_bleu',
            'image'      => '/storage/des_jupes_bain_bleu_default@2x.png',
            'library_id' => 1,
        ]);
        Key::create([
            'key'        => 'des_jupes',
        ...
        Key::create([
            'key'        => 'des_jupes',
            'position'   => 'ou_est_paul',
            'image'      => '/storage/des_jupes_ou_est_paul_default@2x.png',
            'library_id' => 1,
        ]);
        Key::create([
            'key'        => 'des_jupes',
